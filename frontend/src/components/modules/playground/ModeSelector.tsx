...
export default function ModeSelector() {
  ...
  return (
    <div className="space-y-2.5">
      ...
      <div className="flex gap-[2px] p-[3px] bg-foreground/[0.03] rounded-lg border border-foreground/[0.04]">
        <button
          type="button"
      ...
      {category === 'video' && (
        <div className="flex gap-[2px] p-[2px] bg-foreground/[0.02] rounded-md border border-foreground/[0.04]">
          {VIDEO_SUB_MODES.map((m) => (
            <button
              ...
              className={[
                ...
                mode === m.key
                  ? 'text-foreground bg-foreground/[0.1] border border-foreground/[0.08]'
